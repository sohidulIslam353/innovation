			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">All Course</h1>
						...
						<div class="widget posts-widget">
							...
							<div class="single-post">
								<a class="single-post-img" href="blog-post.html">
									<img src="{{URL::to('front/img/post01.jpg')}}" alt="">
								</a>
							...
							<div class="single-post">
								<a class="single-post-img" href="blog-post.html">
									<img src="{{URL::to('front/img/post02.jpg')}}" alt="">
								</a>
								<a href="blog-post.html">Pro eu error molestie deserunt.</a>
								<p><small>By : John Doe .18 Oct, 2017</small></p>
							</div>
							...
							<div class="single-post">
								<a class="single-post-img" href="blog-post.html">
									<img src="{{URL::to('front/img/post03.jpg')}}" alt="">
								</a>
								<a href="blog-post.html">Pro eu error molestie deserunt.</a>
								<p><small>By : John Doe .18 Oct, 2017</small></p>
							</div>

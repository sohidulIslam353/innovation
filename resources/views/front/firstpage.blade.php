...
@section('content')
 ...
 <div id="about" class="section">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="section-header">
                            <h2>Welcome to innovation and development training institute</h2>
                    ...
                    <div class="col-md-6">
                        <div class="about-img">
                        <img src="{{URL::to('front/img/about.png')}}" alt="">
                        </div>
                    </div>
                ...
                <div id="courses-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                ...
                                <img src="{{URL::to('front/img/course01.jpg')}}" alt="">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course02.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
                                <a class="course-title" href="#">Full web design </a>
                                <div class="course-details">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course03.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
                                <a class="course-title" href="#">DIPLOMA IN CALL CENTRE MANAGEMENT (DCCM)</a>
                                <div class="course-details">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course04.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course05.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
                                <a class="course-title" href="#">PHP HYPERTEXT PREPROCESSOR (PHP)</a>
                                <div class="course-details">
                                    <span class="course-category">Web Development</span>
                                    <span class="course-price course-free">Free</span>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course06.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
                                <a class="course-title" href="#">PROGRAMMING IN ADVANCED JAVA (PAJ)</a>
                                <div class="course-details">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course07.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="course">
                                <a href="#" class="course-img">
                                <img src="{{URL::to('front/img/course08.jpg')}}" alt="">
                                    <i class="course-link-icon fa fa-link"></i>
                                </a>
        ...
        <div id="cta" class="section">
            ...
            <!-- Backgound Image -->
            <div class="bg-image bg-parallax overlay" style="background-image:url({{URL::to('front/img/cta1-background.jpg')}})"></div>
            <!-- /Backgound Image -->
        ...
        <div id="why-us" class="section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="section-header text-center">
                        <h2>Why Innovation and Development</h2>
                        <p class="lead">Libris vivendo eloquentiam ex ius, nec id splendide abhorreant.</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        <a class="about-video" href="#">
                            <img src="{{URL::to('front/img/about-video.jpg')}}" alt="">
        ...
        <div id="contact-cta" class="section">
            ...
            <!-- Backgound Image -->
            <div class="bg-image bg-parallax overlay" style="background-image:url({{URL::to('front/img/cta2-background.jpg')}})"></div>
            <!-- Backgound Image -->
